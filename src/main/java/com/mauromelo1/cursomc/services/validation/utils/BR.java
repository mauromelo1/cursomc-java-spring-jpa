package com.mauromelo1.cursomc.services.validation.utils;

//Fonte: https://github.com/adrianoluis/misc-tools/blob/master/src/main/java/net/adrianoluis/tools/util/DocumentUtil.java
public class BR {
	// CPF
